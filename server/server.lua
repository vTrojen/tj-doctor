...
ESX.RegisterServerCallback('werstbay:getEms', function(source, cb, store)
    local ems = 0
...
RegisterServerEvent('werstbay-npcdoctor:money')
AddEventHandler('werstbay-npcdoctor:money', function()
...
ESX.RegisterServerCallback('werstbay-npcdoctor:parakontrol', function(source, cb)
